export { default as LogoWhiteSvg } from './svg/logo-white.svg';
export { default as LogoSvg } from './svg/logo.svg';
export { default as HomeSvg } from './svg/home.svg';
export { default as HomeActiveSvg } from './svg/home-active.svg';
